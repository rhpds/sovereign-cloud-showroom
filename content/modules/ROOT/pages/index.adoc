...
* xref:conclusion.adoc[Conclusion] - Summary, key takeaways, and next steps
...
** *Advanced Cluster Security*: the console for configuring security related items (open {acs_route} in a separate browser tab)
...
image::https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcWtnYWVvd3NmdHB6NXhkZjE1N3BzdGpyZG5vajIzeTY2NDE5a2J6NiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3og0ICZh82LEsNjHoc/giphy.gif[Celebration, width=400, align="center", link=self, window=blank]
