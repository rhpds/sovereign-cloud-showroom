...
The environment set up used Ansible to deploy the applications and configure the clusters.
...
=== Configure a few insecure applications while you work on Module 1
