...
[NOTE]
====
This page is optional reference and extra hands-on material. For the main lab path, complete xref:index.adoc#lab-modules[Modules 1 through 4] in the order listed on the intro page; use Module 5 when you want additional exercises.
====

[[deploying-more-policies-to-hcp-emea]]
