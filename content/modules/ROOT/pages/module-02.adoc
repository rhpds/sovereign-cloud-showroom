...
+
image::compliance-04.png[link=self, window=blank, width=100%]
+
====
...
=== Want More Security Modules?

To dive deeper into software supply chain responsibilities, workload vulnerability management, and Project Hummingbird, please see:

xref:module-05.adoc#understanding-your-responsibilities-for-software-supply-chain-management[Learn more about Software Supply Chain Management and Project Hummingbird in Supplementary Modules]

**Otherwise, Hey! Great job! Proceed to Module 3.**
